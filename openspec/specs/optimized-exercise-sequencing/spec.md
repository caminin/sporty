# optimized-exercise-sequencing Specification

## Purpose
Cette capability implémente un algorithme de séquençage optimisé qui maximise l'alternance entre groupes musculaires différents, créant des séances d'entraînement plus équilibrées et efficaces.
## Requirements
