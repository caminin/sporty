...
### Requirement: Import export tab scope
**Reason**: Import and export are integrated into the catalog and groups tabs respectively; a dedicated third tab is removed.
**Migration**: Use catalog tab for catalog I/O and groups tab for groups I/O; full-list import for manual folder tooling remains server-side only.
