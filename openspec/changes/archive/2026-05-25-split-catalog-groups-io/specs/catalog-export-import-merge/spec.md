...
### Requirement: Export includes catalog and groups
**Reason**: Superseded by separate catalog and groups export requirements above.
**Migration**: Export catalog and groups from their respective admin tabs; combine manually if a full backup is needed.
