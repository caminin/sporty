...
#### Scenario: Migration depuis exercises.json
- **WHEN** un fichier exercises.json existe et aucune liste par défaut n'est présente
- **THEN** le système SHALL migrer automatiquement le contenu vers la liste par défaut
