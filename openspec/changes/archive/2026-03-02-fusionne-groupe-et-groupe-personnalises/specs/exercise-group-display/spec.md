...
Le système DOIT afficher le groupe musculaire de l'exercice en cours dans l'interface timer, sous forme d'un badge discret avec un style visuel distinctif. Le système fonctionne avec la structure unifiée des groupes d'exercices.
...
Le système DOIT afficher un aperçu compact du prochain exercice en bas de l'écran timer, visible pendant les phases de travail et de repos. Le système fonctionne avec la structure unifiée des groupes d'exercices.
